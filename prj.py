...
os.environ['TCL_LIBRARY'] = r'C:\Users\dell.d\AppData\Local\Programs\Python\Python313\tcl\tcl8.6'
...
label = Label(window,textvariable=equation_label,font=('consolas,20'),bg="white",width=39,height=2)
label.pack()
frame = Frame(window)
frame.pack()
